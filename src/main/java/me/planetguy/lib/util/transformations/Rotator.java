...
public class Rotator {
	...
	public static int[] rotateBlock(int px, int py, int pz, ForgeDirection axis, int blockX, int yourY, int yourZ) {
		Matrix coordsMatrixNew = new Matrix(new double[][] { { blockX - px }, { yourY - py }, { yourZ - pz } });
	...
	public static final int[][]	CCWRotationSideMap	= new int[][] { 
		{ 0, 1, 4, 5, 3, 2 }, 
		{ 0, 1, 5, 4, 2, 3 },
		{ 5, 4, 2, 3, 0, 1 }, 
		{ 4, 5, 2, 3, 1, 0 }, 
