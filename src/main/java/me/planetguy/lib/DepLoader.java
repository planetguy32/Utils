 ...
 * This is really unoriginal, stolen wholesale from Chickenbones who mostly ripped off FML, credits to cpw.
 */
...
public class DepLoader implements IFMLLoadingPlugin, IFMLCallHook {
    ...
    private static final String owner = "PlanetguyLib DepLoader";
